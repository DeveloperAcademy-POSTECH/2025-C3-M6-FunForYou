...
enum FFYFont {
    ...
    static let largeTitle: Font = .custom("Pretendard-Bold", size: 34)
    /// font: Pretendard, size: 28, weight: bold
    static let title1: Font = .custom("Pretendard-Bold", size: 28)
    ...
    static let page: Font = .custom("KimjungchulMyungjo-Regular", size: 16)
    /// font: Kimjungchul, size: 14, weight: regular
    static let pages: Font = .custom("KimjungchulMyungjo-Regular", size: 14)
}
